...
import { processPage } from "@/lib/static-pages";
...
export const Route = createFileRoute("/$lang/process")({
  head: ({ params }) => {
    ...
    return buildHead({
      locale,
      path: "/process",
      title: processPage.seoTitle[locale],
      description: processPage.seoDescription[locale],
    });
  },
  component: () => <StaticPage def={processPage} />,
});
